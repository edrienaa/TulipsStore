...
<html
  ...
  <head>
    ...
    <title>Login Admin - Tulips Pharmacy</title>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="materializeadmin/html-version/materializehtml/assets/vendor/css/pages/page-auth.css" />
    <!-- Helpers -->
  ...
  <body>
    ...
    <div class="authentication-wrapper authentication-cover">
      ...
      <a href="index.html" class="auth-cover-brand d-flex align-items-center gap-2">
        ...
        <span class="app-brand-text demo text-heading fw-bold">Tulip's Pharmacy Online Store</span>
      </a>
      <!-- /Logo -->
      <div class="authentication-inner row m-0">
        ...
        <div class="d-none d-lg-flex col-lg-7 col-xl-8 align-items-center justify-content-center p-5 pb-2">
          <img
            src="materializeadmin/html-version/materializehtml/assets/img/illustrations/auth-login-illustration-light.png"
            class="auth-cover-illustration w-100"
            alt="auth-illustration"
            data-app-light-img="illustrations/auth-login-illustration-light.png"
            data-app-dark-img="illustrations/auth-login-illustration-dark.png" />
          <img
            src="materializeadmin/html-version/materializehtml/assets/img/illustrations/auth-cover-login-mask-light.png"
        ...
        <div
          ...
          <div class="w-px-400 mx-auto pt-5 pt-lg-0">
            <h4 class="mb-2 fw-semibold">Welcome to Tulip's Pharmacy👋</h4>
            ...
            <form class="mb-3" action="" method="post">
              ...
              <button type="submit" class="btn btn-primary d-grid w-100" name="submit" value="Login">Sign in</button>
            </form>
          </div>
        </div>
        <!-- /Login -->
    ...
    <!-- Page JS -->
    <script src="materializeadmin/html-version/materializehtml/assets/js/pages-auth.js"></script>
  </body>
</html>
