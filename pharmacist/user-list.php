...
<html
  ...
  <body>
                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        ...
                        <?php
                          $select_user=mysqli_query($connection, "SELECT * FROM user") or die('query_field');
                          $row_count=mysqli_num_rows($select_user);
                        ?>
                        <div class="ms-3">
                          <div class="d-flex align-items-center">
                            <h5 class="mb-0"><?php echo $row_count; ?></h5>
                          </div>
                ...
                <?php
                  if(isset($_POST["registerbtn"])){
                    ...
                    if($number>0){
                      ...
                      $insert_query="INSERT INTO user (UserID, Name, Email, Password, Level)
                      VALUES (?,?,?,?,?)";
                      $result_insert=mysqli_query($connection,$insert_query);
                      if($result_insert){
                        echo "<script>alert('User has been successfully registerec')</script>";
                      }
                    }
                  }
                ?>
                  ...
                  <div class="col-lg-4 col-md-6">
                      <div class="mt-3">
                        ...
                        <div
                          ...
                          <div class="offcanvas-header">
                            <h5 id="offcanvasBothLabel" class="offcanvas-title">Add New User</h5>
                            <button
                              type="button"
                      ...
                      <div class="form-floating form-floating-outline mb-4">
                        <input
                          ...
                          aria-label=""
                          name="user_id" />
                        <label for="add-user-contact">User ID</label>
                      </div>
                      <div class="form-floating form-floating-outline mb-4">
                        <input
                          type="password"
                          ...
                          aria-label=""
                          name="password" />
                        <label for="add-user-company">Password</label>
                      </div>
                      <div class="form-floating form-floating-outline mb-4">
                        <input
                          type="password"
                        ...
                        <label for="add-user-company">Confirm Password</label>
                      </div>
                      <div class="form-floating form-floating-outline mb-4">
                        <select id="user-role" class="form-select" name="level">
                          <option value="Pharmacist">Pharmacist</option>
                          <option value="Staff">Staff</option>
                        </select>
                        <label for="user-role">Level</label>
                      </div>
                            <button type="submit" name="registerbtn" class="btn btn-primary mb-2 d-grid w-100">Save</button>
                            <button
                              type="button"
                            ...
                            <div class="demo-inline-spacing">
                              <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                  <li><a class="dropdown-item" href="pros-delete-user.php?id=<?php echo $user['UserID'];?>" value="<?php include('record-alert.js'); ?>">Delete</a></li>
                                </ul>
                              </div>
                            </div>
                          </div>
    ...
    <!-- Page JS -->
    <!-- <script src="../materializeadmin/html-version/materializehtml/assets/js/app-user-list.js"></script> -->
  </body>
</html>
