...
<?php
  $stmt = $connection->prepare("SELECT * FROM wecareprogram");
  $stmt->execute();
  $wecarelist = $stmt->get_result();
?>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="d-flex align-items-center">
                        ...
                        <?php
                          $select_wecare=mysqli_query($connection, "SELECT * FROM wecareprogram") or die('query_field');
                          $row_count=mysqli_num_rows($select_wecare);
                        ?>
                        <div class="ms-3">
                          <div class="d-flex align-items-center">
                            <h5 class="mb-0"><?php echo $row_count; ?></h5>
                          </div>
                          <small class="text-muted">We Care Customer</small>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card">
                <div class="card-header">
                  <h5 class="card-title">We Care Program</h5>
                  <div class="mt-3">
                    <a href="newwecare-form.php">
                      <button
                ...
                <div class="card-datatable table-responsive">
                  <table class="datatables-users table">
                    ...
                    <tbody>
                    <?php foreach($wecarelist as $wecarelist) { ?>
                      <tr>
                        <td></td>
                        <td>
                          <?php echo $wecarelist['name']; ?>
                        </td>
                        <td>
                          <?php echo $wecarelist['age']; ?>
                        </td>
                        <td>
                          <?php echo $wecarelist['latest_reading']; ?>
                        </td>
                        <td>
                          <?php echo $wecarelist['phone_number']; ?>
                        </td>
                        <td>
                          <div class="col-lg-3 col-sm-6 col-12">
                            <div class="demo-inline-spacing">
                              <div class="btn-group">
                                ...
                                <li><a class="dropdown-item" href="wecareprogram-view.php?id=<?php echo $wecarelist['phone_number'];?>">Account View</a></li>
                                  <li><a class="dropdown-item" href="pros-delete-wecarelist.php?id=<?php echo $wecarelist['phone_number'];?>">Delete</a></li>
                                </ul>
                              </div>
                            </div>
                          </div>
