...
if (isset($_GET['page_no']) && $_GET['page_no'] != "") {
  ...
  $stmt1 = $connection->prepare("SELECT COUNT(*) As total_records FROM brands");
  $stmt1->execute();
  ...
  //4. get all products
  $stmt2 = $connection->prepare("SELECT * FROM brands LIMIT $offset,$total_records_per_page");
  $stmt2->execute();
  $brands = $stmt2->get_result();
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">DataTables /</span> Brands</h4>
              ...
              <?php 
                if(isset($_POST["submit"])){
                  ...
                  $select_query="SELECT * FROM brands WHERE BrandID='$BrandID'";
                  ...
                  if($number>0){
                    ...
                    $insert_query="INSERT INTO brands (BrandID, BrandName)
                    VALUES (?,?)";
                              ...
                              <div class="row">
                                <div class="col mb-4 mt-2">
                                  <div class="form-floating form-floating-outline">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="BrandName" autocomplete="off" required>
            ...
            <!--Form-->
              ...
              <!-- Multilingual -->
              <div class="card">
                <h5 class="card-header">Data of Brand</h5>
                      ...
                      <div class="demo-inline-spacing">
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="pros-list-brand.php?id=<?php echo $brands['BrandID'];?>">List</a></li>
                            <li><a class="dropdown-item" href="pros-edit-brand.php?id=<?php echo $brands['BrandID'];?>">Edit</a></li>
                            <li><a class="dropdown-item" href="pros-delete-brand.php?id=<?php echo $brands['BrandID'];?>">Delete</a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
