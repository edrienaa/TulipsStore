        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Edit /</span> Collection</h4>

              <!-- Basic Layout & Basic with Icons -->
                  <?php
                    $id = $_GET ['id'];

                    $query = mysqli_query ($connection, "SELECT * FROM collections WHERE CollectionsID = '$id'");
                
                    if(isset ($_POST['submit'])){
                
                        $up_CollectionsID = $_POST ['up_CollectionsID'];
                        $up_CollectionsName = $_POST ['up_CollectionsName'];
                        $up_CollectionsQuantity = $_POST ['up_CollectionsQuantity'];
                
                        $query_update = mysqli_query ($connection, "UPDATE collections 
                        SET CollectionsName='$up_CollectionsName', CollectionsQuantity='$up_CollectionsQuantity'
                        WHERE CollectionsID = '$id'");
                
                        echo "<script>alert('Record has been updated');
                        window.location = 'data-collections.php'</script>";
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-name">Collection ID</label>
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="basic-default-name" value="<?php echo $data ['CollectionsID']?>" name="up_CollectionsID">
                          </div>
                        </div>
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-company">Collection Name</label>
                          <div class="col-sm-10">
                            <input
                              type="text"
                              class="form-control"
                              id="basic-default-company"
                              value="<?php echo $data ['CollectionsName']; ?>"
                              name="up_CollectionsName">
                          </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input
                              ...
                              class="form-control"
                              id="basic-default-company"
                              value="<?php echo $data ['CollectionsQuantity']; ?>"
                              name="up_CollectionsQuantity">
                          </div>
                        </div>
