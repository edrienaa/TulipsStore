        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">DataTables /</span> Categories</h4>
              ...
              <?php 
                if(isset($_POST["submit"])){
                  ...
                  $CategoriesQuantity = $_POST ['CategoriesQuantity'];

                  //select data from database
                  $select_query="SELECT * FROM categories WHERE CategoriesID='$CategoriesID'";
                  $result_select=mysqli_query($connection,$select_query);
                  $number=mysqli_num_rows($result_select);
                  if($number>0){
                    echo "<script>alert('Record already exist in the database')</script>";
                  }
                  else{
                    $insert_query="INSERT INTO categories (CategoriesID, CategoriesName, CategoriesQuantity)
                    VALUES ('$CategoriesID', '$CategoriesName', '$CategoriesQuantity')";
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h4 class="modal-title" id="exampleModalLabel3">Add New Categories</h4>
                              <button
                                type="button"
                                class="btn-close"
                            ...
                            <div class="modal-body">
                              <div class="row">
                                <div class="col mb-4 mt-2">
                                  <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control" placeholder="" name="CategoriesName" autocomplete="off" required>
                              ...
                              <div class="row g-2">
                                ...
                                <div class="col mb-2">
                                  <div class="form-floating form-floating-outline">
                                    <input type="number" class="form-control" name="CategoriesQuantity" autocomplete="off" required/>
              ...
              <!-- Multilingual -->
              <div class="card">
                <h5 class="card-header">Data of Categories</h5>
                <div class="card-datatable table-responsive">
                  <table class="dt-multilingual table table-bordered">
                    ...
                    <?php foreach($categories as $categories) { ?>
                      <tr>
                        <td>
                          <?php echo $categories['CategoriesID']; ?>
                        </td>
                        <td>
                          <?php echo $categories['CategoriesName']; ?>
                        </td>
                        <td>
                          <?php
                            // $select_categories=mysqli_query($connection, "SELECT * FROM categories WHERE CategoriesID") or die('query_field');
                            // $row_count_categories=mysqli_num_rows($select_categories);

                            // echo $row_count_categories;
                          ?>
                        </td>
                        <td>
                          <!-- Icon Dropdown -->
                            ...
                            <div class="demo-inline-spacing">
                              <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                  <li><a class="dropdown-item" href="pros-list-collections.php?id=<?php echo $categories['CategoriesID'];?>">List</a></li>
                                  <li><a class="dropdown-item" href="pros-edit-categories.php?id=<?php echo $categories['CategoriesID'];?>">Edit</a></li>
                                  <li><a class="dropdown-item" href="pros-delete-categories.php?id=<?php echo $categories['CategoriesID'];?>">Delete</a></li>
                                </ul>
                              </div>
                            </div>
                          </div>
