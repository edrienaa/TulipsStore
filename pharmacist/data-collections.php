...
if (isset($_GET['page_no']) && $_GET['page_no'] != "") {
  ...
  $stmt1 = $connection->prepare("SELECT COUNT(*) As total_records FROM collections");
  $stmt1->execute();
  ...
  //4. get all products
  $stmt2 = $connection->prepare("SELECT * FROM collections LIMIT $offset,$total_records_per_page");
  $stmt2->execute();
  $collections = $stmt2->get_result();
?>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <?php 
                if(isset($_POST["submit"])){
                  ...
                  $CategoriesQuantity = $_POST ['CollectionsQuantity'];

                  //select data from database
                  $select_query="SELECT * FROM collections WHERE CollectionsID='$CollectionsID'";
                  ...
                  if($number>0){
                    ...
                    $insert_query="INSERT INTO collections (CollectionsID, CategoriesID, CollectionsName, CollectionsQuantity)
                    VALUES ('$CollectionsID','$CategoriesID', '$CollectionsName', '$CollectionsQuantity')";
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            <div class="modal-header">
                              <h4 class="modal-title" id="exampleModalLabel3">Add New Collection</h4>
                              <button
                                type="button"
                                class="btn-close"
                            ...
                            <div class="modal-body">
                              <div class="row">
                                <div class="col mb-4 mt-2">
                                  <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control" placeholder="" name="CollectionsName">
                              ...
                              <div class="row g-2">
                                ...
                                <div class="col mb-2">
                                  <div class="form-floating form-floating-outline">
                                    <input type="text" class="form-control" name="CategoriesID">
                ...
                <div class="card-datatable table-responsive">
                  <table class="dt-multilingual table table-bordered">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td>
                          <?php echo $collections['CollectionsID']; ?>
                        </td>
                        <td>
                          <?php echo $collections['CategoriesID']; ?>
                        </td>
                        <td>
                          <?php echo $collections['CollectionsName']; ?>
                        </td>
                        <td>
                          <?php echo $collections['CollectionsQuantity']; ?>
                        </td>
                        <td>
                          <!-- Icon Dropdown -->
                      ...
                      <div class="demo-inline-spacing">
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="pros-edit-collections.php?id=<?php echo $collections['CollectionsID'];?>">Edit</a></li>
                            <li><a class="dropdown-item" href="pros-delete-collections.php?id=<?php echo $collections['CollectionsID'];?>">Delete</a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
