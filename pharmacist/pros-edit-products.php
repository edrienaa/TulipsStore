        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Edit /</span> Product Detail</h4>
              ...
              <!-- Basic Layout & Basic with Icons -->
                  <?php
                    ...
                    if(isset ($_POST['submit'])){
                        ...
                        $up_ProductsID = $_POST ['up_ProductsID'];
                        $up_ProductName = $_POST ['up_ProductName'];
                        $up_BrandID = $_POST ['up_BrandID'];
                        $up_QuantityInStock = $_POST ['up_QuantityInStock'];
                        $up_Price = $_POST ['up_Price'];
                
                        $query_update = mysqli_query ($connection, "UPDATE products 
                        SET ProductName='$up_ProductName', BrandID='$up_BrandID', QuantityInStock='$up_QuantityInStock', Price='$up_Price'
                        WHERE ProductsID = '$id'");
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-sm-10">
                          <select name="up_BrandID" class="select2 form-select" data-allow-clear="true" required="required">
                            <option value="<?php echo $data ['BrandID']; ?>"><?php echo $data ['BrandID']; ?></option>
                            <?php
                      ...
                      <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="QuantityInStock">Quantity In Stock</label>
                          <div class="col-sm-10">
                            <input 
                                type="number" 
                                class="form-control"
                                name="up_QuantityInStock"
                                value="<?php echo $data ['QuantityInStock']; ?>"
                                autocomplete="off"
                                required="required">
                          </div>
                        </div>
