            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <!-- Basic Layout & Basic with Icons -->
                  <?php
                    ...
                    $query = mysqli_query ($connection, "SELECT * FROM categories WHERE CategoriesID = '$id'");
                
                    if(isset ($_POST['submit'])){
                
                        $up_CategoriesID = $_POST ['up_CategoriesID'];
                        $up_CategoriesName = $_POST ['up_CategoriesName'];
                        $up_CategoriesQuantity = $_POST ['up_CategoriesQuantity'];
                
                        $query_update = mysqli_query ($connection, "UPDATE categories 
                        SET CategoriesName='$up_CategoriesName', CategoriesQuantity='$up_CategoriesQuantity'
                    ...
                    <div class="card-body">
                      <form>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input type="text" class="form-control" id="basic-default-name" value="<?php echo $data ['CategoriesID']?>" name="up_CategoriesID">
                          </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input
                              ...
                              value="<?php echo $data ['CategoriesName']?>"
                              name="up_CategoriesName">
                          </div>
                        </div>
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-10">
                            <input
                              ...
                              class="form-control"
                              id="basic-default-company"
                              value="<?php echo $data ['CategoriesQuantity']?>"
                              name="up_CategoriesQuantity">
                          </div>
                        </div>
