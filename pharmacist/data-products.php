                            ...
                            <div class="demo-inline-spacing">
                              <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                  <li><a class="dropdown-item" href="pros-edit-products.php?id=<?php echo $products['ProductsID'];?>">Edit</a></li>
                                  <li><a class="dropdown-item" href="pros_detail_productsdetail.php?id=<?php echo $products['ProductsID'];?>">Detail</a></li>
                                  <li><a class="dropdown-item" href="pros-delete-products.php?id=<?php echo $products['ProductsID'];?>">Delete</a></li>
                                </ul>
                              </div>
                            </div>
                          </div>
