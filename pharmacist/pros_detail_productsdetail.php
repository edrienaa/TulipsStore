        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">DataTables / Product / </span> Product Detail</h4>
              <div>
                  ...
                  <div class="card mb-4">
                    <div class="card-body">
                      <div class="card-title header-elements">
                        <h5 class="m-0 me-2"><?php echo $data['ProductName']; ?></h5>
                        <div class="card-title-elements ms-auto">
                          <a href="pros-edit-products.php?id=<?php echo $data['ProductsID'];?>">
                            <button type="button" class="btn btn-icon btn-sm btn-primary">
                            <span class="mdi mdi-pencil"></span>
                            </button>
                          </a>
                          <a href="pros-edit-image.php?id=<?php echo $data['ProductsID'];?>">
                            <button type="button" class="btn btn-icon btn-sm btn-primary">
                            <span class="mdi mdi-image-edit"></span>
                            </button>
                          </a>
                          <a href="pros_delete_productsdetail.php?id=<?php echo $data['ProductsID'];?>">
                          <button type="button" class="btn btn-icon btn-sm btn-primary">
                      ...
                      <tr>
                        ...
                        <td> : </td>
                        <td>
                          <p class="card-text"><?php echo $data['ProductsID']; ?></p>
                        </td>
                      </tr>
                      <tr>
                        <td><br></td>
                      ...
                      <tr>
                        ...
                        <td> : </td>
                        <td>
                          <p class="card-text"><?php echo $data['CollectionID']; ?></p>
                        </td>
                      </tr>
                      <tr>
                        <td><br></td>
                      ...
                      <tr>
                        ...
                        <td> : </td>
                        <td>
                          <p class="card-text"><?php echo $data['CategoriesID']; ?></p>
                        </td>
                      </tr>
                      <tr>
                        <td><br></td>
                      ...
                      <tr>
                        ...
                        <td> : </td>
                        <td>
                          <p class="card-text"><?php echo $data['BrandID']; ?></p>
                        </td>
                      </tr>
                      <tr>
                        <td><br></td>
                      ...
                      <tr>
                        ...
                        <td> : </td>
                        <td>
                          <p class="card-text"><?php echo $data['Ingredient']; ?></p>
                        </td>
                      </tr>
                      <tr>
                        <td><br></td>
                      ...
                      <tr>
                        ...
                        <td> : </td>
                        <td>
                          <p class="card-text"><?php echo $data['DOU']; ?></p>
                        </td>
                      </tr>
                      <tr>
                        <td><br></td>
                      ...
                      <tr>
                        ...
                        <td> : </td>
                        <td>
                        <img id="zoom1" src="data:image/png;base64, <?php echo base64_encode($data['Image']); ?>" width="200" height="200" alt="big-1">
                        </td>
                      </tr>
                      <tr>
                        <td><br></td>
                      ...
                      <tr>
                        ...
                        <td> : </td>
                        <td>
                          <p class="card-text">RM <?php echo $data['Price']; ?></p>
                        </td>
                      </tr>
                      </table>
                    </div>
