...
<?php
    if (isset($_GET['order_id'])) {
        ...
        if ($stmt->execute()) {
            header('location: order-list.php?order_updated=Order has been updated succesfully');
        } else{
            header('location: order-list.php?order_failed=Error occured , try again');
        }
     } else {
                  ...
                  <div class="card mb-4">
                    ...
                    <div class="card-body">
                      <form>
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-company">Order Price</label>
                          <div class="col-sm-10">
                            <p>RM <?php echo $r['order_cost']; ?></p>
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="BrandID">Order Status</label>
                        <div class="col-sm-10">
                          <select name="order_status" class="select2 form-select" data-allow-clear="true" required="required">
                        ...
                        <div class="row mb-3">
                          <label class="col-sm-2 col-form-label" for="basic-default-company">Order Date</label>
                          <div class="col-sm-10">
