        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">DataTables / Categories /</span> Collections</h4>
              ...
              <!-- Multilingual -->
                <?php
                      ...
                      $query = mysqli_query ($connection, "SELECT * FROM collections WHERE CategoriesID = '$id'");
                ?>
              <div class="card">
                <h5 class="card-header">Data of Collections</h5>
                <div class="card-datatable table-responsive">
                  <table class="dt-multilingual table table-bordered">
                    ...
                    <tbody>
                      <tr>
                        <td>
                            <?php echo $data['CollectionsID']; ?>
                        </td>
                        <td>
                            <?php echo $data['CollectionsName']; ?>
                        </td>
                        <td>
                            <?php echo $data['CollectionsQuantity']; ?>
                        </td>
                        <td>
                          <!-- Icon Dropdown -->
                      ...
                      <div class="demo-inline-spacing">
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="pros-edit-collections.php?id=<?php echo $data['CollectionsID'];?>">Edit</a></li>
                            <li><a class="dropdown-item" href="pros-delete-collections.php?id=<?php echo $data['CollectionsID'];?>">Delete</a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
