...
<html
  ...
  <head>
    ...
    <link rel="stylesheet" href="../materializeadmin/html-version/materializehtml/assets/vendor/libs/apex-charts/apex-charts.css" />
    <link rel="stylesheet" href="../materializeadmin/html-version/materializehtml/assets/vendor/libs/swiper/swiper.css" />

    <!-- Page CSS -->
    <link rel="stylesheet" href="../materializeadmin/html-version/materializehtml/assets/vendor/css/pages/cards-statistics.css" />
    <!-- Helpers -->
  ...
  <body>
            ...
            <div class="col-lg-10 col-12">
                  <div class="card h-80">
                    <div class="d-flex align-items-end row">
                      <div class="col-md-6">
                        <div class="card-body">
                          <h4 class="card-title pb-2">Welcome <strong></strong><?php echo $result['Name']; ?>🎉</h4>
                      ...
                      <div class="col-md-6 text-center text-md-end">
                        <div class="card-body pb-0 px-0 px-md-4 ps-0">
                          <img
                            src="../materializeadmin/html-version/materializehtml/assets/img/illustrations/illustration-daisy-light.png"
                            height="186"
                            alt="View Profile"
                ...
                <div class="col-lg-4">
                  <div class="card h-1000">
                    <div class="card-body">
                      <h4 class="card-title mb-1 d-flex gap-1 flex-wrap">View Order 😀</h4>
                      <a href="order-list.php" class="btn btn-sm btn-primary">Order List</a>
                    </div>
                    <img src="../materializeadmin/html-version/materializehtml/assets/img/illustrations/illustration-upgrade-account.png" class="
    ...
    <script src="../materializeadmin/html-version/materializehtml/assets/vendor/libs/apex-charts/apexcharts.js"></script>
    <script src="../materializeadmin/html-version/materializehtml/assets/vendor/libs/swiper/swiper.js"></script>

    <!-- Main JS -->
    <script src="../materializeadmin/html-version/materializehtml/assets/js/main.js"></script>

    <!-- Page JS -->
    <script src="../materializeadmin/html-version/materializehtml/assets/js/dashboards-ecommerce.js"></script>
  </body>
</html>
