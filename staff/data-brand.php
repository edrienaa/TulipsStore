                      ...
                      <a class="dropdown-item" href="pages-account-settings-account.html">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            ...
                            $query = mysqli_query ($connection, "SELECT * FROM user WHERE UserID = '$id'");

                            while($data=mysqli_fetch_assoc($query)){

                            ?>
                            <span class="fw-semibold d-block"><?php echo $data['Name']; ?></span>
                            <small class="text-muted"><?php echo $data['Level']; ?></small>
              ...
              <?php 
                if(isset($_POST["submit"])){
                  ...
                  if($number>0){
                    ...
                    $insert_query="INSERT INTO brands (BrandName)
                    VALUES ('$BrandName')";
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                      <div class="demo-inline-spacing">
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="pros-list-brand.php?id=<?php echo $data['BrandID'];?>">List</a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
