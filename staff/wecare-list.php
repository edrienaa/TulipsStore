              ...
              <div class="card">
                ...
                <div class="card-datatable table-responsive">
                  <table class="datatables-users table">
                    ...
                    <?php 
                      $query = mysqli_query ($connection, "SELECT * FROM wecareprogram");
                          ...
                          <div class="col-lg-3 col-sm-6 col-12">
                            <div class="demo-inline-spacing">
                              <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                <li><a class="dropdown-item" href="wecareprogram-view.php?id=<?php echo $data['phone_number'];?>">Account View</a></li>
                                  <li><a class="dropdown-item" href="pros-delete-wecarelist.php?id=<?php echo $data['phone_number'];?>">Delete</a></li>
                                </ul>
                              </div>
                            </div>
                          </div>
