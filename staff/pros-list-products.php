            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <!-- Multilingual -->
                <?php 
                    ...
                    $query = mysqli_query ($connection, "SELECT * FROM products WHERE CollectionsID = '$id'");
                ?>
              <div class="card">
                        ...
                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <p>
                                PRODUCT ID : <?php echo $data['ProductsID']; ?>
                              </p>
                              <p>
                                COLLECTION ID : <?php echo $data['CollectionsID']; ?>
                              </p>
                              <p>
                                CATEGORY ID : <?php echo $data['CategoriesID']; ?>
                              </p>
                              <p>
                                PRODUCT NAME : <?php echo $data['ProductsName']; ?>
                              </p>
                              <p>
                                BRAND NAME : <?php echo $data['BrandName']; ?>
                              </p>
                              <p>
                                DESCRIPTION : <?php echo $data['Description']; ?>
                              </p>
                              <p>
                                INGREDIENT : <?php echo $data['Ingredient']; ?>
                              </p>
                              <p>
                                DIRECTION OF USE : <?php echo $data['DOU']; ?>
                              </p>
                              <p>
                                IMAGE : <img src="<?php echo $data['Image']; ?>" width="100%">
                              </p>
                              <p>
                                PRICE : RM <?php echo $data['Price']; ?>
                              </p>
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                      <div class="demo-inline-spacing">
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu dropdown-menu-end">
                            <li><a class="dropdown-item" href="pros-edit-products.php?id=<?php echo $data['ProductsID'];?>">Edit</a></li>
                            <li><a class="dropdown-item" href="pros-delete-products.php?id=<?php echo $data['ProductsID'];?>">Delete</a></li>
                          </ul>
                        </div>
                      </div>
                    </div>
